...
const _createEdge: (input: string, edgeType: string, output: string) => void = (
  input,
  edgeType,
  output
...
createEdge("formal logic", "influenced", "Russell", "developed", "type theory");
...
createEdge("pragmatism", "influenced", "Dewey", "developed", "instrumentalism");
...
createEdge("Euclid", "wrote", "Elements", "influenced", "Mathematical Physics");
createEdge(
  "Democritus",
  "wrote",
  "Atomism",
...
createEdge("Aquinas", "wrote", "Summa Theologica", "influenced", "Natural Law");
...
createEdge("Bacon", "wrote", "Empirical Method", "influenced", "Royal Society");
createEdge(
  "Boyle",
  "wrote",
  "Corpuscular Theory",
...
createEdge("Leibniz", "wrote", "Monadology", "influenced", "Universal Harmony");
createEdge(
  "Locke",
  "wrote",
  "Essay Concerning Human Understanding",
...
createEdge("Newton", "wrote", "calculus", "influenced", "analytical mechanics");
createEdge(
  "Lagrange",
  "wrote",
  "analytical mechanics",
...
createEdge("Planck", "wrote", "Quantum Theory", "influenced", "Wave Mechanics");
createEdge(
  "Schrödinger",
  "wrote",
  "Wave Mechanics",
...
const RENDERING_CONFIG: RenderingConfig = {
  mode: "type",
  nodeConfig: {
    tags: {},
    types: {
...
export const thinkers2: SceneGraph = new SceneGraph({
  graph,
  metadata: {
    name: "Greatest Minds",
...
console.log(Array.from(toExpand), Array.from(types));
